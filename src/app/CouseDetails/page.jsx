          ...
          {/* <div class="flex items-center justify-between p-4 bg-white ">
            <div>
              <button
                ...
                class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5  dark:text-gray-400  "
                type="button"
              >
            ...
            <label for="table-search" class="sr-only text-black">
              Search
            </label>
            <div class="relative">
              ...
              <input
                ...
                class="block p-2 pl-10 text-sm text-black border  rounded-lg w-80  focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div className="flex justify-center items-center space-x-3">
                          <div className="avatar">
                            <div className="mask mask-squircle w-12 h-12">
                              <Image src={item.picture} alt="" fill={true} />
                            </div>
                          </div>
                        </div>
                      </td>
